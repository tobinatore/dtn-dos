...
\subsubsection{Anwendungsverzeichnis}\label{avz}
\begin{forest}
  pic dir tree,
...
Das Anlegen eines neuen CORE-Projekts sollte direkt in einem neuen Ordner im Basispfad erfolgen, um später Probleme zu vermeiden.\par
